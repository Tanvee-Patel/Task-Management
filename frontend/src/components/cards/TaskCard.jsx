...
const TaskCard = ({ title, description, priority, status, progress, createdAt, dueDate, assignedTo, attachmentCount, completedTodoCount, todoChecklist, onClick }) => {
   ...
   return (
      <div
         className='bg-white rounded-xl shadow-md shadow-gray-100 border border-gray-200/50 cursor-pointer'
         onClick={onClick}
      >
         <div className='flex items-end gap-3 px-4'>
            ...
            <div className={`text-[11px] font-medium ${getPriorityTagColor()} px-4 py-0.5`}>
               {priority} Priority
            </div>
         </div>
